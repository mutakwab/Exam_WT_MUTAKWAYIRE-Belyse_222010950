...
<head>
  ...
  <title>instructors entity Page</title>
  <style>
    /* Normal link */
    a {
      padding: 10px;
...
<section>
  <center>
  <h1><u> Instructor Form </u></h1>
<form method="post" onsubmit="return confirmInsert();">
   <!-- InstructorID Name Email Bio -->
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO instructors(InstructorID, Name, Email, Bio) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $instructorId, $name, $email, $bio);
