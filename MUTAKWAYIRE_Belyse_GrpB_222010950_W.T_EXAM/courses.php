...
<head>
  ...
  <title>courses entity Page</title>
  <style>
    /* Normal link */
    a {
      padding: 10px;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO courses(CourseID, Title, Description, InstructorID) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $courseId, $title, $description, $instructorId);
